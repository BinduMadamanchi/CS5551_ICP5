package com.example.saile.googlemaps;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(myLocation!=null){
            ...
            LatLng usercurrentLocation = new LatLng(myLocation.getLatitude(), myLocation.getLongitude());

            // Creating Marker with userLocation and a Title.
            MarkerOptions currentLocationMarker = new MarkerOptions()
                    .position(usercurrentLocation)
                    .title("Users Location : Latitude : "+myLocation.getLatitude()+ " Longitude : "+myLocation.getLongitude());
            ...
            mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(usercurrentLocation, 14), 1500, null);
        }
    }
    }
